const quotes = [
  ...
  const quotePart = document.getElementById('quote-part');
  const persoPart = document.getElementById('person-part');
  ...
  document.getElementById('quoteBtn').addEventListener('click', () => {
    ...
    document.getElementById('quote-part').innerText = quote;
    document.getElementById('person-part').innerText = ` ${person}`;
  });